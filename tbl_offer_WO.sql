drop view if exists ws_svc_gsa_bi.vw_ani_6208_offer_WO_wc;
create or replace view ws_svc_gsa_bi.vw_ani_6208_offer_WO_wc as (
select distinct
...
and uwf.wo_crt_utc_dts::date > '2019-01-01'
