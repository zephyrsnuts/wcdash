alter view vw_ani_6208_person_wc rename to vw_ani_6208_person_wc_old2;
drop view if exists vw_ani_6208_person_wc;
 create or replace
view vw_ani_6208_person_wc as /* to filter the data for agents, since most of the agent data contains stuff like unkn and fake first name etc
 * beware of comments it causes problems with python scripts
 * any filters have to be edited in the filter_agents cte thats the primary source for any of the filters.
 * note that this data is filtered based on the cases and work orders which are relevant in the filter_agents and data for the past 6 quarters only.
 */
...
;
GRANT SELECT ON TABLE ws_svc_gsa_bi."vw_ani_6208_person_wc" TO ws_grp_svc_gsa_bi_readers;
GRANT ALL ON TABLE ws_svc_gsa_bi."vw_ani_6208_person_wc" TO ws_grp_svc_gsa_bi_writers;
GRANT SELECT ON TABLE ws_svc_gsa_bi."vw_ani_6208_person_wc" TO ws_grp_svc_gsa_bi_writers;
